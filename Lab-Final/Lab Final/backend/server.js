/**
 * @fileoverview BeDentist E-Commerce Server
 * @description Main Express application entry point for BeDentist dental e-commerce platform
 * 
 * Features:
 *   - EJS templating with multiple layouts (site, admin, auth)
 *   - MongoDB Atlas database connection
 *   - Session-based cart and authentication
 *   - RESTful API for products, orders, and users
 *   - Admin panel for store management
 * 
 * @author Ahmed Subhan Tariqi
 * @version 1.0.0
 */
...
// Get directory name for ES modules (required since __dirname is not available in ES modules)
...
// Uses express-ejs-layouts for shared layout templates
// =====================
...
// Used for shopping cart and user authentication
...
// Used to verify API is running (useful for monitoring)
// =====================
